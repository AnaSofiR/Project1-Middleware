#include "cluster/FailoverManager.hpp"
...
// Simulación de ping (a futuro puedes implementar un método real como HealthCheck en gRPC)
bool FailoverManager::pingPeer(const std::string& address) {
    auto channel = grpc::CreateChannel(address, grpc::InsecureChannelCredentials());

    // Aquí podrías hacer un real gRPC ping, por ahora solo intentamos crear el canal.
